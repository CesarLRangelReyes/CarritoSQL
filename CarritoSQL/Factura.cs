    ...
    class Factura
    {
        public class CreaTicket
        {
            ...
            public void TextoDerecha(string par1)
            {
                ...
                max = 50 - par1.Length;                     // obtiene la cantidad de espacios para llegar a 40
                for (int i = 0; i < max; i++)
                {
            ...
            public void TextoExtremos(string par1, string par2)
            {
                ...
                {
                    cort = max - 30;
                    parte1 = par1.Remove(30, cort);          // si par1 es mayor que 18 lo corta
                }
                else { parte1 = par1; }                      // **********
                ...
                {
                    cort = max - 30;
                    parte2 = par2.Remove(30, cort);          // si par2 es mayor que 18 lo corta
                }
                else { parte2 = par2; }
            ...
            public void AgregaTotales(string par1, double total)
            {
                ...
                {
                    cort = max - 33;
                    parte1 = par1.Remove(33, cort);          // si es mayor que 25 lo corta
                }
                else { parte1 = par1; }                      // **********
                ticket = parte1;
            ...
            public void AgregaArticulo(string Articulo, int cant, double precio , double subtotal)
            {
                if (cant.ToString().Length <= 3 && precio.ToString("c").Length <= 10 && subtotal.ToString("c").Length <= 11) // valida que cant precio y total esten dentro de rango
                {
                    ...
                    if (Articulo.Length > 50)                                 // **********
                    {
                        ...
                        for (int Longtext = Articulo.Length; Longtext > 26; Longtext++)
                        {
                            if (bandera == false)
                            {
                                line.AppendLine(Articulo.Substring(CaracterActual, 26) + elementos);
                                bandera = true;
                            }
                            else
                            {
                                line.AppendLine(Articulo.Substring(CaracterActual, 26));
                    ...
                    {
                        for (int i = 0; i < (27 - Articulo.Length); i++)
                        {
                            espacios += " ";
